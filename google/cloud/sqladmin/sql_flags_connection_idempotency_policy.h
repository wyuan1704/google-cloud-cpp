...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_FLAGS_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_FLAGS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class SqlFlagsServiceConnectionIdempotencyPolicy {
 public:
  virtual ~SqlFlagsServiceConnectionIdempotencyPolicy() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_FLAGS_CONNECTION_IDEMPOTENCY_POLICY_H
