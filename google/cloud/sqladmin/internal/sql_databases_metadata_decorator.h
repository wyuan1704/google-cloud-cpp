...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_DATABASES_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_DATABASES_METADATA_DECORATOR_H
...
class SqlDatabasesServiceMetadata : public SqlDatabasesServiceStub {
 public:
  ~SqlDatabasesServiceMetadata() override = default;
  explicit SqlDatabasesServiceMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_DATABASES_METADATA_DECORATOR_H
