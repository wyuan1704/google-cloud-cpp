...
SqlUsersServiceLogging::SqlUsersServiceLogging(
    std::shared_ptr<SqlUsersServiceStub> child, TracingOptions tracing_options,
    std::set<std::string> components)
    : child_(std::move(child)),
      tracing_options_(std::move(tracing_options)),
      components_(std::move(components)) {}

StatusOr<google::cloud::sql::v1::Operation> SqlUsersServiceLogging::Delete(
...
StatusOr<google::cloud::sql::v1::Operation> SqlUsersServiceLogging::Insert(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::sql::v1::Operation> SqlUsersServiceLogging::Update(
    grpc::ClientContext& context,
