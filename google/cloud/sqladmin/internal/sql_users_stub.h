...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_STUB_H
...
class DefaultSqlUsersServiceStub : public SqlUsersServiceStub {
 public:
  explicit DefaultSqlUsersServiceStub(
      std::unique_ptr<google::cloud::sql::v1::SqlUsersService::StubInterface>
          grpc_stub)
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_STUB_H
