...
#include "google/cloud/sqladmin/internal/sql_databases_metadata_decorator.h"
...
SqlDatabasesServiceMetadata::SqlDatabasesServiceMetadata(
    std::shared_ptr<SqlDatabasesServiceStub> child)
    : child_(std::move(child)),
      api_client_header_(
          google::cloud::internal::ApiClientHeader("generator")) {}

StatusOr<google::cloud::sql::v1::Operation> SqlDatabasesServiceMetadata::Delete(
...
StatusOr<google::cloud::sql::v1::Database> SqlDatabasesServiceMetadata::Get(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::sql::v1::Operation> SqlDatabasesServiceMetadata::Insert(
    grpc::ClientContext& context,
...
SqlDatabasesServiceMetadata::List(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::sql::v1::Operation> SqlDatabasesServiceMetadata::Patch(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::sql::v1::Operation> SqlDatabasesServiceMetadata::Update(
    grpc::ClientContext& context,
    google::cloud::sql::v1::SqlDatabasesUpdateRequest const& request) {
  SetMetadata(context, {});
...
void SqlDatabasesServiceMetadata::SetMetadata(
    grpc::ClientContext& context, std::string const& request_params) {
  context.AddMetadata("x-goog-request-params", request_params);
  SetMetadata(context);
}

void SqlDatabasesServiceMetadata::SetMetadata(grpc::ClientContext& context) {
