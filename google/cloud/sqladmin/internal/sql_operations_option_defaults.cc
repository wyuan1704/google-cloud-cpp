...
Options SqlOperationsServiceDefaultOptions(Options options) {
  options = google::cloud::internal::PopulateCommonOptions(
      std::move(options), "GOOGLE_CLOUD_CPP_SQL_OPERATIONS_SERVICE_ENDPOINT",
      "", "sqladmin.googleapis.com");
  options =
      google::cloud::internal::PopulateGrpcOptions(std::move(options), "");
  if (!options.has<sqladmin::SqlOperationsServiceRetryPolicyOption>()) {
    options.set<sqladmin::SqlOperationsServiceRetryPolicyOption>(
        sqladmin::SqlOperationsServiceLimitedTimeRetryPolicy(
            std::chrono::minutes(30))
            .clone());
  }
  if (!options.has<sqladmin::SqlOperationsServiceBackoffPolicyOption>()) {
    options.set<sqladmin::SqlOperationsServiceBackoffPolicyOption>(
  ...
  if (!options.has<
    ...
    options.set<
        sqladmin::SqlOperationsServiceConnectionIdempotencyPolicyOption>(
        sqladmin::MakeDefaultSqlOperationsServiceConnectionIdempotencyPolicy());
  }
