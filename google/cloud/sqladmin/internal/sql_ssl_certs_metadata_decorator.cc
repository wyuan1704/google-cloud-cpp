...
SqlSslCertsServiceMetadata::SqlSslCertsServiceMetadata(
    std::shared_ptr<SqlSslCertsServiceStub> child)
    : child_(std::move(child)),
      api_client_header_(
          google::cloud::internal::ApiClientHeader("generator")) {}

StatusOr<google::cloud::sql::v1::Operation> SqlSslCertsServiceMetadata::Delete(
...
StatusOr<google::cloud::sql::v1::SslCert> SqlSslCertsServiceMetadata::Get(
    grpc::ClientContext& context,
...
SqlSslCertsServiceMetadata::Insert(
    grpc::ClientContext& context,
...
SqlSslCertsServiceMetadata::List(
    grpc::ClientContext& context,
...
void SqlSslCertsServiceMetadata::SetMetadata(
    grpc::ClientContext& context, std::string const& request_params) {
  context.AddMetadata("x-goog-request-params", request_params);
  SetMetadata(context);
}

void SqlSslCertsServiceMetadata::SetMetadata(grpc::ClientContext& context) {
