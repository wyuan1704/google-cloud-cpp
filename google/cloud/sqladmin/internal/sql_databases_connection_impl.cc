...
SqlDatabasesServiceConnectionImpl::SqlDatabasesServiceConnectionImpl(
    ...
    : background_(std::move(background)),
      ...
      options_(internal::MergeOptions(
          std::move(options),
          sqladmin_internal::SqlDatabasesServiceDefaultOptions(
              SqlDatabasesServiceConnection::options()))) {}

StatusOr<google::cloud::sql::v1::Operation>
SqlDatabasesServiceConnectionImpl::Delete(
...
SqlDatabasesServiceConnectionImpl::Get(
...
StatusOr<google::cloud::sql::v1::Operation>
SqlDatabasesServiceConnectionImpl::Insert(
...
SqlDatabasesServiceConnectionImpl::List(
...
StatusOr<google::cloud::sql::v1::Operation>
SqlDatabasesServiceConnectionImpl::Patch(
...
StatusOr<google::cloud::sql::v1::Operation>
SqlDatabasesServiceConnectionImpl::Update(
    google::cloud::sql::v1::SqlDatabasesUpdateRequest const& request) {
  return google::cloud::internal::RetryLoop(
