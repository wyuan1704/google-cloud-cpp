...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_METADATA_DECORATOR_H
...
class SqlUsersServiceMetadata : public SqlUsersServiceStub {
 public:
  ~SqlUsersServiceMetadata() override = default;
  explicit SqlUsersServiceMetadata(std::shared_ptr<SqlUsersServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_METADATA_DECORATOR_H
