...
SqlBackupRunsServiceMetadata::SqlBackupRunsServiceMetadata(
...
SqlBackupRunsServiceMetadata::Delete(
...
StatusOr<google::cloud::sql::v1::BackupRun> SqlBackupRunsServiceMetadata::Get(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::sql::v1::Operation>
SqlBackupRunsServiceMetadata::Insert(
    grpc::ClientContext& context,
...
SqlBackupRunsServiceMetadata::List(
    grpc::ClientContext& context,
...
void SqlBackupRunsServiceMetadata::SetMetadata(
    grpc::ClientContext& context, std::string const& request_params) {
  context.AddMetadata("x-goog-request-params", request_params);
  SetMetadata(context);
}

void SqlBackupRunsServiceMetadata::SetMetadata(grpc::ClientContext& context) {
