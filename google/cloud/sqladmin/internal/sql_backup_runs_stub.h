...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_BACKUP_RUNS_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_BACKUP_RUNS_STUB_H
...
class SqlBackupRunsServiceStub {
 public:
  virtual ~SqlBackupRunsServiceStub() = 0;
...
class DefaultSqlBackupRunsServiceStub : public SqlBackupRunsServiceStub {
 public:
  explicit DefaultSqlBackupRunsServiceStub(
      std::unique_ptr<
          google::cloud::sql::v1::SqlBackupRunsService::StubInterface>
          grpc_stub)
 ...
 private:
  std::unique_ptr<google::cloud::sql::v1::SqlBackupRunsService::StubInterface>
      grpc_stub_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_BACKUP_RUNS_STUB_H
