...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_INSTANCES_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_INSTANCES_LOGGING_DECORATOR_H
...
class SqlInstancesServiceLogging : public SqlInstancesServiceStub {
 public:
  ~SqlInstancesServiceLogging() override = default;
  SqlInstancesServiceLogging(std::shared_ptr<SqlInstancesServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_INSTANCES_LOGGING_DECORATOR_H
