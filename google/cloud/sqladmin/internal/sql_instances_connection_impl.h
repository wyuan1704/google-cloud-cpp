...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_INSTANCES_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_INSTANCES_CONNECTION_IMPL_H
...
#include "google/cloud/sqladmin/sql_instances_options.h"
...
class SqlInstancesServiceConnectionImpl
    : public sqladmin::SqlInstancesServiceConnection {
 public:
  ~SqlInstancesServiceConnectionImpl() override = default;

  SqlInstancesServiceConnectionImpl(
 ...
 private:
  std::unique_ptr<sqladmin::SqlInstancesServiceRetryPolicy> retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<sqladmin::SqlInstancesServiceRetryPolicyOption>()) {
      return options.get<sqladmin::SqlInstancesServiceRetryPolicyOption>()
          ->clone();
    }
    return options_.get<sqladmin::SqlInstancesServiceRetryPolicyOption>()
        ->clone();
  }

  std::unique_ptr<BackoffPolicy> backoff_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<sqladmin::SqlInstancesServiceBackoffPolicyOption>()) {
      return options.get<sqladmin::SqlInstancesServiceBackoffPolicyOption>()
          ->clone();
    }
    return options_.get<sqladmin::SqlInstancesServiceBackoffPolicyOption>()
        ->clone();
  }

  std::unique_ptr<sqladmin::SqlInstancesServiceConnectionIdempotencyPolicy>
  idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<
            sqladmin::SqlInstancesServiceConnectionIdempotencyPolicyOption>()) {
      return options
          .get<sqladmin::SqlInstancesServiceConnectionIdempotencyPolicyOption>()
          ->clone();
    }
    return options_
        .get<sqladmin::SqlInstancesServiceConnectionIdempotencyPolicyOption>()
  ...
  std::shared_ptr<sqladmin_internal::SqlInstancesServiceStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_INSTANCES_CONNECTION_IMPL_H
