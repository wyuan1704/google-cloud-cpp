...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_INSTANCES_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_INSTANCES_METADATA_DECORATOR_H
...
class SqlInstancesServiceMetadata : public SqlInstancesServiceStub {
 public:
  ~SqlInstancesServiceMetadata() override = default;
  explicit SqlInstancesServiceMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_INSTANCES_METADATA_DECORATOR_H
