...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_SSL_CERTS_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_SSL_CERTS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class SqlSslCertsServiceConnectionIdempotencyPolicy {
 public:
  virtual ~SqlSslCertsServiceConnectionIdempotencyPolicy() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_SSL_CERTS_CONNECTION_IDEMPOTENCY_POLICY_H
