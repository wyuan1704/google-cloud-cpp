...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_LOGGING_DECORATOR_H
...
class SqlUsersServiceLogging : public SqlUsersServiceStub {
 public:
  ~SqlUsersServiceLogging() override = default;
  SqlUsersServiceLogging(std::shared_ptr<SqlUsersServiceStub> child,
 ...
 private:
  std::shared_ptr<SqlUsersServiceStub> child_;
  TracingOptions tracing_options_;
  std::set<std::string> components_;
};  // SqlUsersServiceLogging
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_LOGGING_DECORATOR_H
