...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_DATABASES_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_DATABASES_CONNECTION_IDEMPOTENCY_POLICY_H
...
class SqlDatabasesServiceConnectionIdempotencyPolicy {
 public:
  virtual ~SqlDatabasesServiceConnectionIdempotencyPolicy() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_DATABASES_CONNECTION_IDEMPOTENCY_POLICY_H
