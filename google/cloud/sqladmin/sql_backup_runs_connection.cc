...
#include "google/cloud/sqladmin/internal/sql_backup_runs_stub_factory.h"
...
MakeSqlBackupRunsServiceConnection(Options options) {
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      options, __func__);
  options =
      sqladmin_internal::SqlBackupRunsServiceDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = sqladmin_internal::CreateDefaultSqlBackupRunsServiceStub(
      background->cq(), options);
  return std::make_shared<
      sqladmin_internal::SqlBackupRunsServiceConnectionImpl>(
...
MakeSqlBackupRunsServiceConnection(
  ...
  options = SqlBackupRunsServiceDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  return std::make_shared<
      sqladmin_internal::SqlBackupRunsServiceConnectionImpl>(
      std::move(background), std::move(stub), std::move(options));
