...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_AUTH_DECORATOR_H
...
class SqlUsersServiceAuth : public SqlUsersServiceStub {
 public:
  ~SqlUsersServiceAuth() override = default;
  SqlUsersServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_USERS_AUTH_DECORATOR_H
