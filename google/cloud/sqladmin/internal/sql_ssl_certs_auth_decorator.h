...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_SSL_CERTS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_SSL_CERTS_AUTH_DECORATOR_H
...
class SqlSslCertsServiceAuth : public SqlSslCertsServiceStub {
 public:
  ~SqlSslCertsServiceAuth() override = default;
  SqlSslCertsServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_SSL_CERTS_AUTH_DECORATOR_H
