...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_DATABASES_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_DATABASES_LOGGING_DECORATOR_H
...
class SqlDatabasesServiceLogging : public SqlDatabasesServiceStub {
 public:
  ~SqlDatabasesServiceLogging() override = default;
  SqlDatabasesServiceLogging(std::shared_ptr<SqlDatabasesServiceStub> child,
 ...
 private:
  std::shared_ptr<SqlDatabasesServiceStub> child_;
  TracingOptions tracing_options_;
  std::set<std::string> components_;
};  // SqlDatabasesServiceLogging
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_DATABASES_LOGGING_DECORATOR_H
