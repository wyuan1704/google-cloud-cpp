...
SqlSslCertsServiceAuth::SqlSslCertsServiceAuth(
    std::shared_ptr<google::cloud::internal::GrpcAuthenticationStrategy> auth,
    std::shared_ptr<SqlSslCertsServiceStub> child)
    : auth_(std::move(auth)), child_(std::move(child)) {}

StatusOr<google::cloud::sql::v1::Operation> SqlSslCertsServiceAuth::Delete(
...
StatusOr<google::cloud::sql::v1::SslCert> SqlSslCertsServiceAuth::Get(
    grpc::ClientContext& context,
