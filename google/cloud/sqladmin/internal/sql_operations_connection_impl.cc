...
SqlOperationsServiceConnectionImpl::SqlOperationsServiceConnectionImpl(
    ...
    : background_(std::move(background)),
      ...
      options_(internal::MergeOptions(
          std::move(options),
          sqladmin_internal::SqlOperationsServiceDefaultOptions(
              SqlOperationsServiceConnection::options()))) {}

StatusOr<google::cloud::sql::v1::Operation>
SqlOperationsServiceConnectionImpl::Get(
...
SqlOperationsServiceConnectionImpl::List(
