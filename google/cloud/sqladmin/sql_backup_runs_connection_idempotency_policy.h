...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_BACKUP_RUNS_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_BACKUP_RUNS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class SqlBackupRunsServiceConnectionIdempotencyPolicy {
 public:
  virtual ~SqlBackupRunsServiceConnectionIdempotencyPolicy() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_BACKUP_RUNS_CONNECTION_IDEMPOTENCY_POLICY_H
