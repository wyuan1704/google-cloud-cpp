...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_BACKUP_RUNS_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_BACKUP_RUNS_METADATA_DECORATOR_H
...
class SqlBackupRunsServiceMetadata : public SqlBackupRunsServiceStub {
 public:
  ~SqlBackupRunsServiceMetadata() override = default;
  explicit SqlBackupRunsServiceMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_BACKUP_RUNS_METADATA_DECORATOR_H
