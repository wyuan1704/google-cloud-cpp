...
SqlOperationsServiceLogging::SqlOperationsServiceLogging(
...
StatusOr<google::cloud::sql::v1::Operation> SqlOperationsServiceLogging::Get(
...
SqlOperationsServiceLogging::List(
    grpc::ClientContext& context,
