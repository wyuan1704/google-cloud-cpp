...
SqlUsersServiceStub::~SqlUsersServiceStub() = default;

StatusOr<google::cloud::sql::v1::Operation> DefaultSqlUsersServiceStub::Delete(
...
StatusOr<google::cloud::sql::v1::Operation> DefaultSqlUsersServiceStub::Insert(
    grpc::ClientContext& client_context,
...
DefaultSqlUsersServiceStub::List(
    grpc::ClientContext& client_context,
    google::cloud::sql::v1::SqlUsersListRequest const& request) {
  google::cloud::sql::v1::UsersListResponse response;
...
StatusOr<google::cloud::sql::v1::Operation> DefaultSqlUsersServiceStub::Update(
    grpc::ClientContext& client_context,
