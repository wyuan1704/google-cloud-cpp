...
SqlOperationsServiceStub::~SqlOperationsServiceStub() = default;

StatusOr<google::cloud::sql::v1::Operation>
DefaultSqlOperationsServiceStub::Get(
...
DefaultSqlOperationsServiceStub::List(
    grpc::ClientContext& client_context,
    google::cloud::sql::v1::SqlOperationsListRequest const& request) {
  google::cloud::sql::v1::OperationsListResponse response;
