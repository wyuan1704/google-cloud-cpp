...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_DATABASES_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_DATABASES_AUTH_DECORATOR_H
...
class SqlDatabasesServiceAuth : public SqlDatabasesServiceStub {
 public:
  ~SqlDatabasesServiceAuth() override = default;
  SqlDatabasesServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_INTERNAL_SQL_DATABASES_AUTH_DECORATOR_H
