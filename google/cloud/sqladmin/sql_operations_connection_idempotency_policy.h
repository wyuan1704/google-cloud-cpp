...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_OPERATIONS_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_OPERATIONS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class SqlOperationsServiceConnectionIdempotencyPolicy {
 public:
  virtual ~SqlOperationsServiceConnectionIdempotencyPolicy() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_OPERATIONS_CONNECTION_IDEMPOTENCY_POLICY_H
