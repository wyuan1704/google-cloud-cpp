...
SqlBackupRunsServiceLogging::SqlBackupRunsServiceLogging(
...
StatusOr<google::cloud::sql::v1::Operation> SqlBackupRunsServiceLogging::Delete(
...
StatusOr<google::cloud::sql::v1::BackupRun> SqlBackupRunsServiceLogging::Get(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::sql::v1::Operation> SqlBackupRunsServiceLogging::Insert(
    grpc::ClientContext& context,
...
SqlBackupRunsServiceLogging::List(
    grpc::ClientContext& context,
