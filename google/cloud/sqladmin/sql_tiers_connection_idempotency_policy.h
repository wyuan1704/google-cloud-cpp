...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_TIERS_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_TIERS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class SqlTiersServiceConnectionIdempotencyPolicy {
 public:
  virtual ~SqlTiersServiceConnectionIdempotencyPolicy() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQLADMIN_SQL_TIERS_CONNECTION_IDEMPOTENCY_POLICY_H
